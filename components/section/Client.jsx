...
export default function Client() {
  ...
  return (
    <section className='max-w-7xl mx-auto px-[15px]'>
        <p className='text-center text-[18px] md:text-[18px] text-primary font-miniver'>Partners & Clients</p>
        <h1 className='text-center text-[30px] md:text-[48px] font-bold'>We work with the best pepole</h1>
        <ClientShowcaseCard
            items={clients}
            direction="right"
            speed="fast"
